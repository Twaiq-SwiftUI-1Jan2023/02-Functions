...
progressUpdate(steps: 10, goal: 1_000)
progressUpdate(steps: 100, goal: 250)
progressUpdate(steps: 850, goal: 1000)
progressUpdate(steps: 670, goal: 700)
...
func pacing(currentDistance:Double,totalDistance:Double,currentTime:Double,goalTime:Double){
    if (((totalDistance - currentDistance) / currentTime) + currentTime) <= goalTime {
        print("Keep it up!")
    } else {
        print("You've got to push it just bit harder!")
    }
}
pacing(currentDistance: 80, totalDistance: 100, currentTime: 15, goalTime: 16)
/*:
