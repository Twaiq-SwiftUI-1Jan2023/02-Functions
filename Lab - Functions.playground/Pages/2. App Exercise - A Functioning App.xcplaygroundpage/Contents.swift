 ...
 */
var steps = 0
func incrementSteps ( stepsNum : Int) -> Int {

    steps = stepsNum + 1
    return steps
}
incrementSteps(stepsNum: steps)
incrementSteps(stepsNum: steps)
incrementSteps(stepsNum: steps)
incrementSteps(stepsNum: steps)
...
let goal = 10000 
func progressUpdate ( stepsGoal : Int) -> Int{
    if stepsGoal < (goal / 10){
        print("You're off to a good start.")
    }else if stepsGoal < (goal / 2){
        print("You're almost halfway there!" )
    }else if stepsGoal < 9000 {
        print("You're almost halfway there!" )
    }else if stepsGoal < goal{
...
progressUpdate(stepsGoal: steps)
/*:
