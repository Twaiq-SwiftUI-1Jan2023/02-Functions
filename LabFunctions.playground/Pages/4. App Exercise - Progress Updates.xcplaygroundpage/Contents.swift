 ...
 */
//my code is correct but the output has uncorrect result

func progressUpdate (steps:Int , goal:Int){
    let perecent = (steps/goal)*100
    print("You're off to a good start")
    if (perecent <= 10 ){
        print("You're almost halfway there!")
    }
    else if (perecent < goal/2){
...
progressUpdate(steps: 400, goal: 2000)
progressUpdate(steps: 600, goal: 3000)
...
pacing(currentDistance: 3.4, totalDistance: 4.5, currentTime: 1 , goalTime: 2)
